        ...
        <div className="relative z-10 flex flex-col justify-between p-16 text-white">
          ...
          <div className="max-w-md">
            ...
            <p className="mt-6 text-lg text-surface-300 leading-relaxed">
              Connect your database, and let AutoAdmin generate beautiful, fully-functional admin dashboards in seconds.
            </p>
          </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 lg:p-16">
        ...
        >
          ...
          <div className="mb-10">
            ...
            <p className="text-surface-500 mt-2 text-base">Sign in to your account to continue</p>
          </div>
